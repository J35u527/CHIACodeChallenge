...
{
	public sealed class RefreshTableHeaderView : UIView
	{
		...
		public RefreshTableHeaderView () : base ()
		{
			...
			lastUpdatedLabel = new UILabel (new RectangleF (0f, (float)this.Frame.Height - 30f, 320f, 20f));
			...
			statusLabel = new UILabel (new RectangleF (0f, (float)this.Frame.Height - 48f, 320f, 20f));
			...
			arrowImage = new UIImageView (new RectangleF (25f, (float)this.Frame.Height - 65f, 30f, 55f));
			...
			activityView.Frame = new RectangleF (25f, (float)this.Frame.Height - 38f, 20f, 20f);
